...
async function main() {
  ...
  const cities = await Promise.all([
    ...
    prisma.city.upsert({ where: { name_country: { name: "Seoul", country: "South Korea" } }, update: {}, create: { name: "Seoul", country: "South Korea", region: "Asia", costIndex: 3, popularity: 84, description: "K-pop capital with palaces, nightlife, and incredible street food.", imageUrl: "https://plus.unsplash.com/premium_photo-1661886333708-877148b43ae1?w=800&q=80" } }),
    ...
    prisma.city.upsert({ where: { name_country: { name: "Petra", country: "Jordan" } }, update: {}, create: { name: "Petra", country: "Jordan", region: "Middle East", costIndex: 2, popularity: 79, description: "Ancient rose-red city carved into cliff faces — a world wonder.", imageUrl: "https://images.unsplash.com/photo-1615811648503-479d06197ff3?w=800&q=80" } }),
  ]);
